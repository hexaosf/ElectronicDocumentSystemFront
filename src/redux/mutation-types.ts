...
// 设置 setEncryption
export const SET_UPLOAD_ENCRYPTION = "SET_UPLOAD_ENCRYPTION";
// 设置 setKey
export const SET_UPLOAD_ENCRYPTION_KEY = "SET_UPLOAD_ENCRYPTION_KEY";
// 设置 setSm2TargetUsername
export const SET_SM2_TARGET_USERNAME = "SET_SM2_TARGET_USERNAME";
